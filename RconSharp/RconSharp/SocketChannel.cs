            ...
            int writeTimeout = 5000)
        {
            if (string.IsNullOrEmpty(host))
            {
                throw new ArgumentException(
                    "Invalid host name: must be a non null non empty string containing the host's address");
            }
            ...
            if (readTimeout < 0)
            {
                throw new ArgumentException("Read timeout parameter must be a positive value");
            }

            if (writeTimeout < 0)
            {
                throw new ArgumentException("Write timeout parameter must be a positive value");
            }
