...
namespace RconSharp
{
    ...
    public class RconPacket
    {
        ...
        public static Lazy<RconPacket> Dummy { get; } =
            new(() => new RconPacket { Id = 0, Type = PacketType.Response });
        ...
        public byte[] ToBytes(Encoding encoding)
        {
            ...
            body.CopyTo(span[12..]);
            BitConverter.GetBytes(body.Length + 9).CopyTo(span[..4]);
        ...
        {
            return FromBytes(buffer, Encoding.UTF8);
        }
        ...
        public static RconPacket FromBytes(byte[] buffer, Encoding encoding)
        {
            ...
            if (size > buffer.Length - 4)
            {
                throw new ArgumentOutOfRangeException(
                    $"Declared packet size [{size}] is larger than actual buffer length");
            }
